...
// ─────────────────────────────────────────────────────────────
// Mock Tickets (sprint ticket table on Dashboard)
// ─────────────────────────────────────────────────────────────
...
export const MOCK_TICKETS: Ticket[] = [
  ...
  },
  {
    ...
    carryForwardReason: 'Carried forward from Sprint 23 — needs a follow-up to cover DST edge cases after the initial fix.',
  ...
  },
  {
    ...
    fixVersion: 'v2.5.0',
    carryForward: 'Sprint 22',
    carryForwardReason: 'Carried forward from Sprint 22 — scope grew to include the audit-log requirement after security review.',
  ...
  },
  {
    ...
    carryForwardReason: 'Carried forward from Sprint 21 — needs a runner image upgrade from infra team to stabilize the integration stage.',
