    ...
    <View style={styles.container}>
      ...
      <View style={styles.filterSection}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.filterChips}>
          ...
          >
            <Ionicons name="apps" size={14} color={!typeFilter ? '#fff' : '#a78bfa'} />
...
const styles = StyleSheet.create({
  ...
  badgeWrap: { width: 40, height: 40, borderRadius: 16, backgroundColor: '#8b5cf6', alignItems: 'center', justifyContent: 'center' },
  ...
  filterChip: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(27, 28, 31, 0.95)', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(167,139,250,0.15)', gap: 6 },
