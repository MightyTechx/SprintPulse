...
const TAB_ITEMS = [
  { name: 'createTicket', icon: 'add-circle-outline', activeIcon: 'add-circle', label: 'Create' },
  { name: 'searchTicket', icon: 'search-outline', activeIcon: 'search', label: 'Search' },
...
export default function PTWTabLayout() {
  return (
    <Tabs
      screenOptions={{
        headerShown: false,
    ...
    >
      <Tabs.Screen name='createTicket' options={{ title: 'Create' }} />
      <Tabs.Screen name='searchTicket' options={{ title: 'Search' }} />
