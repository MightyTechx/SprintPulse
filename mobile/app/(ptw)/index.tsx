...
const styles = StyleSheet.create({
  ...
  liveText: { color: '#10b981', fontWeight: '700', fontSize: 12 },
  ...
  filterChip: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.background.surface, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(167,139,250,0.15)', gap: 6 },
